...
public class loginbean {
    ...
    public void init() {
        User admin = new User();
        admin.setFirstname("Garton");
        admin.setLastname("Lenzile");
        admin.setUsername("Lenzile45");
        admin.setDateOfBirth(new Date());
        admin.setPassword(Base64.getEncoder().encodeToString("garton".getBytes()));
        admin.setEmail("mymanager@gmail.com");
        admin.setRole(1);
